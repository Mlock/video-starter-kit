...
import { ModelEndpointPicker } from "./ModelEndpointPicker";
import { AssetPreview } from "./AssetPreview";
import { ImgBox } from "./ImgBox";
import { StoryGenerator } from "./StoryGenerator";

// Add Google Fonts API URL (from the original file)
const GOOGLE_FONTS_API =
  "https://www.googleapis.com/webfonts/v1/webfonts?key=YOUR_API_KEY";

// Popular Google Fonts for video text (from the original file)
const POPULAR_FONTS = [
